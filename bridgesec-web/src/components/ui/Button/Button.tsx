...
export interface ButtonProps
    ...
    variant?: 'solid' | 'plain' | 'light' | 'default' | 'coloredBorder'
...
const Button = forwardRef<HTMLButtonElement, ButtonProps>((props, ref) => {
    ...
    const lightColor = () => {
        const btn = {
            bgColor: active
                ? ``
                : `bg-primary-light dark:bg-gray-700 dark:hover:bg-primary dark:hover:text-white`,
            textColor: `text-primary dark:text-primary hover:text-white active:text-white`,
            hoverColor: active
                ? ''
                : `hover:bg-primary-mild`,
            activeColor: ``,
        }
        return getBtnColor(btn)
    }
