...
var applyChangeset = (obj, changeset) => {
  if (changeset) {
    changeset.forEach((change) => {
      ...
      if (value !== null && value !== void 0 || type === "REMOVE") {
  ...
  for (const subchange of change.changes) {
    if (subchange.value != null || subchange.type === "REMOVE") {
      ...
      if (change.embeddedKey === "$index") {
        ...
        element = (0, import_lodash.find)(arr, (el) => {
          var _a;
          return ((_a = el[change.embeddedKey]) == null ? void 0 : _a.toString()) === subchange.key.toString();
        });
      }
