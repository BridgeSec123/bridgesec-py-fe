...
function useZoomPan(_ref) {
  ...
  (0, import_react.useEffect)(function() {
    ...
    var zoom2 = zoom_default2().filter(filterFunc).scaleExtent([minZoom, maxZoom]).translateExtent([[a1, a2], [b12, b22]]).on("start", handleZoomStart).on("zoom", handleZoom).on("end", handleZoomEnd);
  ...
  (0, import_react.useEffect)(function() {
    ...
    svg.call(zoomRef.current.transform, identity.translate(width / 2 - x, height / 2 - y).scale(zoom));
    setPosition({
      x: width / 2 - x,
      y: height / 2 - y,
      k: zoom
