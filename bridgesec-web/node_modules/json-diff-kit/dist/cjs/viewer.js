...
const Viewer = (props)=>{
    ...
    const linesLeftRef = React__namespace.useRef(linesLeft);
    ...
    const totalHeightRef = React__namespace.useRef(0);
    const tbodyRef = React__namespace.useRef(null);
    ...
    const renderLine = (index, syntaxHighlightEnabled)=>{
        ...
        /*#__PURE__*/ React__namespace.createElement("tr", {
            key: index
        }, props.lineNumbers && /*#__PURE__*/ React__namespace.createElement("td", {
            className: `line-${l.type} line-number`,
            style: {
                backgroundColor: bgLeft
            }
        }, l.lineNumber), /*#__PURE__*/ React__namespace.createElement("td", {
        ...
        }, r.lineNumber), /*#__PURE__*/ React__namespace.createElement("td", {
    ...
    const renderExpandLine = (hasLinesBefore, hasLinesAfter, expandMoreLinesLimit, index)=>{
        return /*#__PURE__*/ React__namespace.createElement(React__namespace.Fragment, null, hasLinesBefore && /*#__PURE__*/ React__namespace.createElement("button", {
    ...
    const renderTbody = (syntaxHighlightEnabled)=>{
        ...
        return visibleSegments.length ? /*#__PURE__*/ React__namespace.createElement(React__namespace.Fragment, null, /*#__PURE__*/ React__namespace.createElement("tr", null, /*#__PURE__*/ React__namespace.createElement("td", {
            colSpan: 4,
            style: {
                height: topHeight,
                padding: 0
        ...
        }))) : /*#__PURE__*/ React__namespace.createElement("tr", null, /*#__PURE__*/ React__namespace.createElement("td", {
            colSpan: 4,
            style: {
                height: `${totalHeightRef.current}px`
            }
    ...
    const renderMeasureLine = ()=>/*#__PURE__*/ React__namespace.createElement("colgroup", {
            className: "measure-line"
        }, props.lineNumbers && /*#__PURE__*/ React__namespace.createElement("col", {
            style: {
                width: lineNumberWidth
            }
        }), /*#__PURE__*/ React__namespace.createElement("col", null), props.lineNumbers && /*#__PURE__*/ React__namespace.createElement("col", {
            style: {
                width: lineNumberWidth
            }
