    ...
    if (!obj || typeof obj !== 'object') {
        ...
        if (result === undefined) {
            switch(undefinedBehavior){
                case exports.UndefinedBehavior.throw:
                    throw new Error(`Value is not valid in JSON, got ${String(obj)}`);
                case exports.UndefinedBehavior.stringify:
...
const formatValue = (value, depth = Infinity, pretty = false, undefinedBehavior = exports.UndefinedBehavior.stringify)=>{
    if (value === null) {
        return 'null';
    }
...
exports.UndefinedBehavior = void 0;
...
})(exports.UndefinedBehavior || (exports.UndefinedBehavior = {}));
